...
function initializeInventoryFilters() {
  ...
  const allFilterBtn = document.querySelector(
    '.inventory-filter[data-filter="all"]'
  );
  if (allFilterBtn) {
...
function createDeviceTableRow(device) {
  ...
  row.innerHTML = `
    ...
    <td>
      <div class="btn-group">
        <button class="btn btn-sm device-details-btn" onclick="showDeviceDetails('${
          device.id
        }')">
...
function showDeviceDetails(deviceId) {
  ...
  document.getElementById(
    "modalDeviceModel"
  ).textContent = `${device.brand} ${device.model}`;
  document.getElementById("modalDeviceCondition").textContent =
    device.condition;

  // Format received date
  const receivedDate = new Date(device.receivedDate);
  document.getElementById("modalDeviceDate").textContent =
  ...
  document.getElementById(
    "modalDeviceUser"
  ).textContent = `${device.user.firstName} ${device.user.lastName}`;
  document.getElementById("modalDeviceUserEmail").textContent =
    device.user.email;
...
function getDevices() {
  ...
  if (storedInventory) {
    try {
      ...
      // If parsing fails, fall back to dummy data
    }
  }
  // Fallback to dummy data if nothing in storage or if data is corrupt
...
function getDummyDevices() {
  return [
    ...
    },
    {
      ...
      images: ["https://placehold.co/600x400?text=Galaxy+Tab+S7+Front"],
    },
    {
      id: "REC12348",
      type: "Smartphone",
      ...
      images: ["https://placehold.co/400x600?text=Galaxy+S22+Ultra"],
    },
    {
      id: "REC12349",
      type: "Laptop",
    ...
    },
    {
      ...
      images: ["https://placehold.co/400x400?text=Apple+Watch+Series+7"],
    },
    {
      id: "REC12351",
      type: "Tablet",
      ...
      images: ["https://placehold.co/600x400?text=iPad+Pro+12.9"],
    },
    {
      id: "REC12352",
      type: "Other",
      ...
      images: ["https://placehold.co/600x400?text=PlayStation+5"],
    },
    {
      id: "REC12353",
      type: "Smartphone",
      ...
      specs: {
        ...
        battery: "5003 mAh",
        camera: "50MP Wide, 48MP Telephoto, 12MP Ultrawide",
      },
      images: ["https://placehold.co/400x600?text=Pixel+6+Pro"],
    },
    {
      id: "REC12354",
      type: "Laptop",
      ...
      images: ["https://placehold.co/600x400?text=HP+Spectre+x360"],
    },
  ];
}
